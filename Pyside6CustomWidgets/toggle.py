from PySide6.QtCore import QPropertyAnimation, QEasingCurve, QSequentialAnimationGroup, QPoint, QSize, Slot, QRectF, \
    QPointF, Property
from PySide6.QtGui import QPen, Qt, QBrush, QColor, QPaintEvent, QPainter
